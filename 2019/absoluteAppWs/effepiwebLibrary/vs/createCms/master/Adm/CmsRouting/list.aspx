<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" EnableEventValidation="false" Inherits="backOffice.cmsrouting.list" %>
...
<body>
    <form id="frmList" runat="server">
        <ucNavBar:navBar ID="navBar1" runat="server" CurrentContentTable="CmsRouting" />
                ...
                <div class="page-content">
					...
					<div class="page-body">
						<div class="row">
						        ...
						        <div class="widget">
									<div class="widget-header bordered-bottom bordered-primary">
                                        <span class="widget-caption">
                                            <asp:Literal ID="Literal_Cms_RecordListFor" runat="server">List</asp:Literal> CmsRouting</span>
                                        <span class="widget-caption pull-right padding-right-20">
                                            <label>
                                                ...
                                                <span class="text">Show deleted records</span>
                                            </label>
                                        </span>
                                    </div>
                                    <div class="well">										
							...
							<th class="record-data-header txt-middle"><asp:Literal ID="Literal_Column_Header_NameRoute" runat="server">NameRoute</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_NameRoute" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="NameRoute" runat="server"><i id="iLinkButton_Column_Header_NameRoute" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
							<th class="record-data-header txt-middle"><asp:Literal ID="Literal_Column_Header_UrlMapping" runat="server">UrlMapping</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_UrlMapping" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="UrlMapping" runat="server"><i id="iLinkButton_Column_Header_UrlMapping" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
							<th class="record-data-header txt-middle"><asp:Literal ID="Literal_Column_Header_UrlPhysicalPage" runat="server">UrlPhysicalPage</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_UrlPhysicalPage" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="UrlPhysicalPage" runat="server"><i id="iLinkButton_Column_Header_UrlPhysicalPage" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
							<th class="record-data-header txt-middle"><asp:Literal ID="Literal_Column_Header_MetaTagTitle" runat="server">MetaTagTitle</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_MetaTagTitle" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="MetaTagTitle" runat="server"><i id="iLinkButton_Column_Header_MetaTagTitle" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
							<th class="record-data-header txt-middle"><asp:Literal ID="Literal_Column_Header_MetaTagDescription" runat="server">MetaTagDescription</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_MetaTagDescription" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="MetaTagDescription" runat="server"><i id="iLinkButton_Column_Header_MetaTagDescription" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
							<th class="record-data-header txt-middle"><asp:Literal ID="Literal_Column_Header_MetaTagKeywords" runat="server">MetaTagKeywords</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_MetaTagKeywords" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="MetaTagKeywords" runat="server"><i id="iLinkButton_Column_Header_MetaTagKeywords" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>


											        </tr>
											    </thead>
											    <tbody class="listsortable" runat="server" id="tbody" ContentTable="CmsRouting">
											            ...
											            <ItemTemplate>
											                <tr>
											                    ...
											                    <td style="white-space: nowrap;">
											                        <asp:HyperLink ID="HyperLink_Edit" CssClass="lnkAction btn btn-default btn-sm shiny icon-only" runat="server" ToolTip="Modifica"><i class="fa fa-edit"></i></asp:HyperLink>
											                        <asp:HyperLink ID="HyperLink_Delete" CssClass="lnkAction btn btn-default btn-sm shiny icon-only" runat="server" NavigateUrl="javascript:;" ToolTip="Elimina"><i class="fa fa-trash-o"></i></asp:HyperLink>
											                        <asp:HyperLink ID="HyperLink_EnableDisable" CssClass="lnkAction btn btn-default btn-sm shiny icon-only" runat="server" NavigateUrl="javascript:;" ToolTip="Cambia Stato"><i class="fa fa-power-off" id="li_LinkButton_EnableDisable" runat="server"></i></asp:HyperLink>
											                    </td>									
									<td class="record-data txt-middle"><asp:Literal ID="Literal_Column_NameRoute" runat="server"></asp:Literal></td>
									<td class="record-data txt-middle"><asp:Literal ID="Literal_Column_UrlMapping" runat="server"></asp:Literal></td>
									<td class="record-data txt-middle"><asp:Literal ID="Literal_Column_UrlPhysicalPage" runat="server"></asp:Literal></td>
									<td class="record-data txt-middle"><asp:Literal ID="Literal_Column_MetaTagTitle" runat="server"></asp:Literal></td>
									<td class="record-data txt-middle"><asp:Literal ID="Literal_Column_MetaTagDescription" runat="server"></asp:Literal></td>
									<td class="record-data txt-middle"><asp:Literal ID="Literal_Column_MetaTagKeywords" runat="server"></asp:Literal></td>
