...
{
    public partial class CmsHtmlEditor : System.Web.UI.UserControl
    {
        #region objUtil
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //
            Value = CKEditorControl_Value.Text.Replace("\n", "").Replace("\r", "");
        ...
        protected void InitUC()
        {
            ...
            if (Required)
                RequiredFieldValidator_CKEditorControl_Value.Enabled = true;

            if (MaxLength > 0)
                CKEditorControl_Value.MaxLength = MaxLength;

            CKEditorControl_Value.BasePath = sCmsStartingpage + "ckeditor/";

        }
        public void SetValue(String _Value)
        {
            if (!String.IsNullOrEmpty(_Value))
                CKEditorControl_Value.Text = _Value;
