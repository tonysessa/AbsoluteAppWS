<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" EnableEventValidation="false" Inherits="backOffice.adm.cmsresources.list" %>
...
<head>
    ...
    <title>Elenco CmsResources</title>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="record-data-header txt-middle">
                                                            <asp:Literal ID="Literal_Column_Header_Description" runat="server">Description</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_Description" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="Description" runat="server"><i id="iLinkButton_Column_Header_Description" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
                                                        <!--<th class="record-data-header txt-long"><asp:Literal ID="Literal_Column_Header_Note" runat="server">Note</asp:Literal></th>-->


                                                    </tr>
                                                </thead>
                                                <tbody class="listsortable" runat="server" id="tbody" contenttable="CmsResources">
                                                    <asp:Repeater ID="Repeater_List_Column" runat="server">
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td class="record-data txt-middle">
                                                                    <asp:Literal ID="Literal_Column_Description" runat="server"></asp:Literal></td>
