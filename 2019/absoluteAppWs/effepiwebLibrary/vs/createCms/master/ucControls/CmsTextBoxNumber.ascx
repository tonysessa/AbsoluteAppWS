<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CmsTextBoxNumber.ascx.cs"
    Inherits="backOffice.ucControls.CmsTextBoxNumber" %>
<!-- SHORT TEXT -->
<asp:Panel ID="Panel_Input" runat="server" CssClass="form-group">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator_TextBoxNumber_Value" runat="server" SetFocusOnError="true" Display="Dynamic" ControlToValidate="TextBoxNumber_Value" ErrorMessage="Required Field" Enabled="false"></asp:RequiredFieldValidator>
    <asp:RegularExpressionValidator ID="RegularExpressionValidator_TextBoxNumber_Value" SetFocusOnError="true" Display="Dynamic" ControlToValidate="TextBoxNumber_Value" ValidationExpression="^[\d]+([,][0-9]{1,2})?$" ErrorMessage="Valore non valido" runat="server"></asp:RegularExpressionValidator>
    <!-- -->
