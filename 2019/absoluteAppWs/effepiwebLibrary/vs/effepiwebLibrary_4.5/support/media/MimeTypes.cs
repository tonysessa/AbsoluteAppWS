...
namespace Support.Library
{
    public class MimeTypes
    {
        ...
        public static string GetMimeType(string extension, string def)
        {
            ...
            return !String.IsNullOrEmpty(mime) ? mime : def;
        }

        public static string GetExtension(string mime,string def)
        {
            foreach (String ext in _mappings.Keys)
                if (String.Compare(_mappings[ext], mime, true) == 0)
                    return ext;
            /*
            string[] tks = mime.Split(new char[2] { '/', '-' }, StringSplitOptions.RemoveEmptyEntries);
            if (tks.Length > 1)
