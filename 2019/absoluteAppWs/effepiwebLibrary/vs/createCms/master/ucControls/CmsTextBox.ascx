<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CmsTextBox.ascx.cs"
    Inherits="backOffice.ucControls.CmsTextBox" %>
<!-- SHORT TEXT -->
<asp:Panel ID="Panel_Input" runat="server" CssClass="form-group">
    ...
    <asp:TextBox ID="TextBox_Value" runat="server" CssClass="form-control" Rows="5"></asp:TextBox>
