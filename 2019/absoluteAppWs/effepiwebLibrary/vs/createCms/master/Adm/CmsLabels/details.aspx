<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="details.aspx.cs" Inherits="backOffice.adm.cmslabels.details" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" ValidateRequest="false" %>
...
<head>
    ...
    <title>Dettagli CmsLabels</title>
                                        ...
                                        <div class="widget">
                                            <div class="widget-header bordered-bottom bordered-primary">
                                                <span class="widget-caption">
                                                    <asp:Literal ID="Literal_Cms_RecordDetail" runat="server">Dettaglio</asp:Literal> CmsLabels</span>
                                            ...
                                            <asp:Panel ID="Panel_Content_Form" runat="server" Visible="true" CssClass="widget-body" EnableViewState="false">
                                                ...
                                                <uc4:CmsTextBox ID="CmsTextBox_Key" Title="Key" MaxLength="150" Required="true" runat="server" showSpacer="true" cmsLabelKey="Cms.CmsLabels.Key" />
                                                <uc3:CmsHtmlEditor ID="CmsHtmlEditor_Description" Title="Description" showSpacer="true" runat="server" cmsLabelKey="Cms.CmsLabels.Description" />
                                                <uc3:CmsHtmlEditor ID="CmsHtmlEditor_Note" Title="Note" showSpacer="true" runat="server" cmsLabelKey="Cms.CmsLabels.Note" />
