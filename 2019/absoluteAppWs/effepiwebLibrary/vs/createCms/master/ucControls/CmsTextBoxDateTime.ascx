<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CmsTextBoxDateTime.ascx.cs" Inherits="backOffice.ucControls.CmsTextBoxDateTime" %>
...
<asp:Panel ID="Panel_Input" runat="server" CssClass="form-group">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="input-group">
                <asp:TextBox class="form-control dateti-picker" ID="TextBoxTime_Value" runat="server" type="text"></asp:TextBox>
                <span class="input-group-addon">
                    <i class="fa fa-clock-o"></i>
                </span>
            </div>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator_TextBoxTime_Value" runat="server" Display="Dynamic"
                SetFocusOnError="true" ControlToValidate="TextBoxTime_Value" ErrorMessage="required"
                Enabled="false"></asp:RequiredFieldValidator>
        </div>
    </div>
    <!-- -->
...
<script>
    $(document).ready(function () {
        ...
        $("#<%=TextBoxTime_Value.ClientID %>").timepicker({
            defaultTime: '',
            showMeridian: false,
            autoclose: true,
            minuteStep: 10
