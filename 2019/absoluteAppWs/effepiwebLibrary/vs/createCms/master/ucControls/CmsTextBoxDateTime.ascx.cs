...
{
    public partial class CmsTextBoxDateTime : System.Web.UI.UserControl
    {
        #region objUtil
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (TextBoxDate_Value.Text.Length > 0)
            {
                ...
                String sValueTime = TextBoxTime_Value.Text;

                if ((!String.IsNullOrEmpty(sValueDate)) && (String.IsNullOrEmpty(sValueTime)))
                {
                    //
                    sValue = sValueDate + " 00:00:00";
                }
                else
                {
                    if (sValueTime.Length.Equals(4))
                        sValueTime = "0" + sValueTime + ":00";
                    else
                        sValueTime = sValueTime + ":00";
                    sValue = sValueDate + " " + sValueTime;
                }

                Value = objLibDate.StringToDateTime(sValue, "GMA", " ", "/", ":");
            }
            else
        ...
        protected void InitUC()
        {
            ...
            if (Required)
            {
                ...
                RequiredFieldValidator_TextBoxTime_Value.Enabled = true;
            }

            if (ReadOnly)
            {
                TextBoxDate_Value.ReadOnly = true;
                TextBoxTime_Value.ReadOnly = true;
            }
        ...
        public void SetValue(DateTime _Value)
        {
            if (!DateTime.MinValue.Equals(_Value))
            {
                ...
                TextBoxTime_Value.Text = _Value.Hour.ToString() + ":" + _Value.Minute.ToString().PadLeft(2, '0');
            }
        }
