    ...
    public partial class list : System.Web.UI.Page
    {
        ...
        protected void InitPage()
        {
			...
			*/
            ...
            HyperLink_Action_Enable.Attributes.Add("data-content", "CmsRouting");
            ...
            HyperLink_Action_Disable.Attributes.Add("data-content", "CmsRouting");
            ...
            HyperLink_Action_Delete.Attributes.Add("data-content", "CmsRouting");
            ...
            //Cms.CmsRouting.NameRoute;
            cmsLabelKey = "Cms.CmsRouting.NameRoute";
            ...
            Literal_Column_Header_NameRoute.Text = headerTitle;
            //Cms.CmsRouting.UrlMapping;
            cmsLabelKey = "Cms.CmsRouting.UrlMapping";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
            Literal_Column_Header_UrlMapping.Text = headerTitle;
            //Cms.CmsRouting.UrlPhysicalPage;
            cmsLabelKey = "Cms.CmsRouting.UrlPhysicalPage";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
            Literal_Column_Header_UrlPhysicalPage.Text = headerTitle;
            //Cms.CmsRouting.MetaTagTitle;
            cmsLabelKey = "Cms.CmsRouting.MetaTagTitle";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
            Literal_Column_Header_MetaTagTitle.Text = headerTitle;
            //Cms.CmsRouting.MetaTagDescription;
            cmsLabelKey = "Cms.CmsRouting.MetaTagDescription";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
            Literal_Column_Header_MetaTagDescription.Text = headerTitle;
            //Cms.CmsRouting.MetaTagKeywords;
            cmsLabelKey = "Cms.CmsRouting.MetaTagKeywords";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
            Literal_Column_Header_MetaTagKeywords.Text = headerTitle;
        ...
        {
		    //
            liPagerSize15.Attributes.Remove("class");
        ...
        protected void Repeater_List_Bind(Boolean bPaging)
        {
            ...
            // List Response
            CmsRoutingListResponse responseList = objCmsBoDataLibs.CmsRoutingList(header, rq);
        ...
        protected void Repeater_List_Column_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                //
                CmsRouting currentObj = (CmsRouting)e.Item.DataItem;
                ...
                myHyperLink_Delete.Attributes.Add("data-content", "CmsRouting");
                ...
                myHyperLink_EnableDisable.Attributes.Add("data-content", "CmsRouting");
                ...
                // NameRoute
                String sNameRoute = String.Empty;
                if (currentObj.NameRoute != null)
                    sNameRoute = currentObj.NameRoute.ToString();
                Literal myLiteral_Column_NameRoute = (Literal)e.Item.FindControl("Literal_Column_NameRoute");
                myLiteral_Column_NameRoute.Text = sNameRoute;
                
                // UrlMapping
                String sUrlMapping = String.Empty;
                if (currentObj.UrlMapping != null)
                    sUrlMapping = currentObj.UrlMapping.ToString();
                Literal myLiteral_Column_UrlMapping = (Literal)e.Item.FindControl("Literal_Column_UrlMapping");
                myLiteral_Column_UrlMapping.Text = sUrlMapping;
                
                // UrlPhysicalPage
                String sUrlPhysicalPage = String.Empty;
                if (currentObj.UrlPhysicalPage != null)
                    sUrlPhysicalPage = currentObj.UrlPhysicalPage.ToString();
                Literal myLiteral_Column_UrlPhysicalPage = (Literal)e.Item.FindControl("Literal_Column_UrlPhysicalPage");
                myLiteral_Column_UrlPhysicalPage.Text = sUrlPhysicalPage;
                
                // MetaTagTitle
                String sMetaTagTitle = String.Empty;
                if (currentObj.MetaTagTitle != null)
                    sMetaTagTitle = currentObj.MetaTagTitle.ToString();
                Literal myLiteral_Column_MetaTagTitle = (Literal)e.Item.FindControl("Literal_Column_MetaTagTitle");
                myLiteral_Column_MetaTagTitle.Text = sMetaTagTitle;
                
                // MetaTagDescription
                String sMetaTagDescription = String.Empty;
                if (currentObj.MetaTagDescription != null)
                    sMetaTagDescription = currentObj.MetaTagDescription.ToString();
                Literal myLiteral_Column_MetaTagDescription = (Literal)e.Item.FindControl("Literal_Column_MetaTagDescription");
                myLiteral_Column_MetaTagDescription.Text = sMetaTagDescription;
                
                // MetaTagKeywords
                String sMetaTagKeywords = String.Empty;
                if (currentObj.MetaTagKeywords != null)
                    sMetaTagKeywords = currentObj.MetaTagKeywords.ToString();
                Literal myLiteral_Column_MetaTagKeywords = (Literal)e.Item.FindControl("Literal_Column_MetaTagKeywords");
                myLiteral_Column_MetaTagKeywords.Text = sMetaTagKeywords;
