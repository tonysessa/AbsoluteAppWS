    ...
    public partial class export : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
			...
			if (currentCmsUserSession != null)
            {
				...
				// List Response
				CmsLabelsListResponse responseList = objCmsBoDataLibs.CmsLabelsListCms(header, rq);
                ...
                listColumns[9] = "Note";
				    ...
				    objXLS.InitAndAddRowsObject(myListGeneric, listColumns,"CmsLabels", false);
                ...
                listColumns[9] = "Note";
					...
					objXLS.UpdateRow(listColumns, 0, "CmsLabels");
					*/

					//
				    objXLS.SaveXlsToWeb("CmsLabelsExport.xls");
				}
			}
        }       
        #endregion
