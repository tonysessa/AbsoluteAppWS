<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" EnableEventValidation="false" Inherits="backOffice.cmssections.list" %>
...
<head>
    ...
    <title>Elenco CmsSections</title>
                ...
                <div class="page-content">
					...
					<div class="page-body">
						<div class="row">
						        ...
						        <div class="widget">
									<div class="widget-header bordered-bottom bordered-primary">
                                        <span class="widget-caption">
                                            <asp:Literal ID="Literal_Cms_RecordListFor" runat="server">Elenco</asp:Literal> CmsSections</span>
                                        <span class="widget-caption pull-right padding-right-20">
                                            <label>
                                                ...
                                                <span class="text"><asp:Literal ID="Literal_ShowDeleted" runat="server">Show deleted records</asp:Literal></span>
                                            </label>
                                        </span>
                                    </div>
                                    <div class="well">										
										<div class="table-toolbar">
						                    ...
						                    <div class="btn-group margin-bottom-20">
						                        <asp:LinkButton ID="Button_ReorderRecord" runat="server" CssClass="btn btn-default" OnClick="Button_ReorderRecord_Click" CausesValidation="false" Visible="true"><i class='fa fa-sort'></i> Reorder record</asp:LinkButton>
						                        <asp:LinkButton ID="Button_ApplyReorder" runat="server" CssClass="btn btn-default disabled" OnClick="Button_ApplyReorder_Click" CausesValidation="false" Visible="true"><i class='fa fa-check'></i> Apply order</asp:LinkButton>
						                    </div>
							...
							<th class="record-data-header txt-middle"><asp:Literal ID="Literal_Column_Header_Title" runat="server">Title</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_Title" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="Title" runat="server"><i id="iLinkButton_Column_Header_Title" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
							<th class="record-data-header txt-middle"><asp:Literal ID="Literal_Column_Header_ContentTable" runat="server">ContentTable</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_ContentTable" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="ContentTable" runat="server"><i id="iLinkButton_Column_Header_ContentTable" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
							<th class="record-data-header txt-middle"><asp:Literal ID="Literal_Column_Header_SectionUri" runat="server">SectionUri</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_SectionUri" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="SectionUri" runat="server"><i id="iLinkButton_Column_Header_SectionUri" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
							<th class="record-data-header txt-middle"><asp:Literal ID="Literal_Column_Header_Link" runat="server">Link</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_Link" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="Link" runat="server"><i id="iLinkButton_Column_Header_Link" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
							<th class="record-data-header txt-middle"><asp:Literal ID="Literal_Column_Header_Link_Target" runat="server">Link_Target</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_Link_Target" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="Link_Target" runat="server"><i id="iLinkButton_Column_Header_Link_Target" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
							<th class="record-data-header txt-middle"><asp:Literal ID="Literal_Column_Header_Link_Preview" runat="server">Link_Preview</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_Link_Preview" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="Link_Preview" runat="server"><i id="iLinkButton_Column_Header_Link_Preview" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
							<th class="record-data-header txt-middle"><asp:Literal ID="Literal_Column_Header_IconClass" runat="server">IconClass</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_IconClass" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="IconClass" runat="server"><i id="iLinkButton_Column_Header_IconClass" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>


											        </tr>
											    </thead>
											    <tbody class="listsortable" runat="server" id="tbody" ContentTable="CmsSections">
									...
									<td class="record-data txt-middle"><asp:Literal ID="Literal_Column_Title" runat="server"></asp:Literal></td>
									<td class="record-data txt-middle"><asp:Literal ID="Literal_Column_ContentTable" runat="server"></asp:Literal></td>
									<td class="record-data txt-middle"><asp:Literal ID="Literal_Column_SectionUri" runat="server"></asp:Literal></td>
									<td class="record-data txt-middle"><asp:Literal ID="Literal_Column_Link" runat="server"></asp:Literal></td>
									<td class="record-data txt-middle"><asp:Literal ID="Literal_Column_Link_Target" runat="server"></asp:Literal></td>
									<td class="record-data txt-middle"><asp:Literal ID="Literal_Column_Link_Preview" runat="server"></asp:Literal></td>
									<td class="record-data txt-middle"><asp:Literal ID="Literal_Column_IconClass" runat="server"></asp:Literal></td>
