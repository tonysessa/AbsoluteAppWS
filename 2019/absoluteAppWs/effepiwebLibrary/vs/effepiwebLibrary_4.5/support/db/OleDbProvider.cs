...
namespace Support.db
{
    ...
    public class OleDbProvider : ADataProvider
	{
		///<summary>
        ...
        public override SimpleDataSet executeQuery(string query, int maxRows)
		{
            ...
            cmd.Connection = (OleDbConnection)dbConn;
			//
			try
			{
        ...
        public override bool executeStatement(string query)
        {
            ...
            try
            {
                OleDbCommand cmd = new OleDbCommand(query, (OleDbConnection)dbConn);
                cmd.ExecuteNonQuery();
                bReturn = true;
        ...
        public override bool executeStatement(string query, Hashtable paramters)
        {
            ...
            try
            {
                ...
                foreach (String k in paramters.Keys)
                {
                    ...
                    if (paramters[k]==null)
                        p = new OleDbParameter("@" + k, DBNull.Value);
                    else
                        p = new OleDbParameter("@" + k, paramters[k]);
                    //
        ...
        public override DbDataReader openCursor(string sql)
        {
            ...
            try
            {
                OleDbCommand command = new OleDbCommand(sql, (OleDbConnection)dbConn);
                //
