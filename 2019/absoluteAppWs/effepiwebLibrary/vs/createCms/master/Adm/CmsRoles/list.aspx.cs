...
namespace backOffice.cmsroles
{
    public partial class list : System.Web.UI.Page
    {
        ...
        protected void InitPage()
        {
            ...
            HyperLink_Action_Enable.Attributes.Add("data-content", "CmsRoles");
            ...
            HyperLink_Action_Disable.Attributes.Add("data-content", "CmsRoles");
            ...
            HyperLink_Action_Delete.Attributes.Add("data-content", "CmsRoles");
            ...
            //Cms.CmsRoles.Title;
            cmsLabelKey = "Cms.CmsRoles.Title";
            ...
            //Cms.CmsRoles.Uriname;
            cmsLabelKey = "Cms.CmsRoles.Uriname";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
            Literal_Column_Header_Uriname.Text = headerTitle;
			...
			*/
            ...
            // Uc
            sidebarMenu1.currentCmsSubSections = "CmsRoles";
			sidebarMenu1.currentCmsSubSections_SectionUri = sectionUri;
            sidebarMenu1.currentCmsUserSession = currentCmsUserSession;
        ...
        protected void Repeater_List_Bind(Boolean bPaging)
        {
            ...
            // List Response
            CmsRolesListResponse responseList = objCmsBoDataLibs.CmsRolesList(header, rq);
        ...
        protected void Repeater_List_Column_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                //
                CmsRoles currentObj = (CmsRoles)e.Item.DataItem;
                ...
                myHyperLink_Delete.Attributes.Add("data-content", "CmsRoles");
                ...
                myHyperLink_EnableDisable.Attributes.Add("data-content", "CmsRoles");
                ...
                if (currentObj.Uriname != null)
                    sUriname = currentObj.Uriname.ToString();
                Literal myLiteral_Column_Uriname = (Literal)e.Item.FindControl("Literal_Column_Uriname");
                myLiteral_Column_Uriname.Text = sUriname;
