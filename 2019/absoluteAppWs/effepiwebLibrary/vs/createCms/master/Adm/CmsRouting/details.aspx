<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="details.aspx.cs" Inherits="backOffice.cmsrouting.details" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" ValidateRequest="false" %>
...
<head>
    ...
    <title>Details CmsRouting</title>
                                        ...
                                        <div class="widget">
                                            <div class="widget-header bordered-bottom bordered-primary">
                                                <span class="widget-caption">
                                                    <asp:Literal ID="Literal_Cms_RecordDetail" runat="server">Details</asp:Literal> CmsRouting</span>
                                            ...
                                            <asp:Panel ID="Panel_Content_Form" runat="server" Visible="true" CssClass="widget-body" EnableViewState="false">
                                                ...
                                                <uc4:CmsTextBox ID="CmsTextBox_NameRoute" Title="Nameroute" MaxLength="150" Required="true" runat="server" showSpacer="true" cmsLabelKey="Cms.CmsRouting.NameRoute" />
                                                <uc4:CmsTextBox ID="CmsTextBox_UrlMapping" Title="Urlmapping" MaxLength="1000" TextMode="MultiLine" Required="true" runat="server" showSpacer="true"  cmsLabelKey="Cms.CmsRouting.UrlMapping" />
                                                <uc4:CmsTextBox ID="CmsTextBox_UrlPhysicalPage" Title="Urlphysicalpage" MaxLength="255" runat="server" showSpacer="true" cmsLabelKey="Cms.CmsRouting.UrlPhysicalPage" />
                                                <uc4:CmsTextBox ID="CmsTextBox_MetaTagTitle" Title="Metatagtitle" MaxLength="255" runat="server" showSpacer="true" cmsLabelKey="Cms.CmsRouting.MetaTagTitle" />
                                                <uc4:CmsTextBox ID="CmsTextBox_MetaTagDescription" Title="Metatagdescription" MaxLength="1000" TextMode="MultiLine" runat="server" showSpacer="true" cmsLabelKey="Cms.CmsRouting.MetaTagDescription" />
                                                <uc4:CmsTextBox ID="CmsTextBox_MetaTagKeywords" Title="Metatagkeywords" MaxLength="1000" TextMode="MultiLine" runat="server" showSpacer="true" cmsLabelKey="Cms.CmsRouting.MetaTagKeywords" />
