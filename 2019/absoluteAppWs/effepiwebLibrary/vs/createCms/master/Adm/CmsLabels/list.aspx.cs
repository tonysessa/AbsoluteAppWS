...
namespace backOffice.adm.cmslabels
{
    public partial class list : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // Uc
            sidebarMenu1.currentCmsSubSections = "AdminCmsLabels";
        ...
        protected void InitPage()
        {
            ...
            HyperLink_Action_Enable.Attributes.Add("data-content", "CmsLabels");
            ...
            HyperLink_Action_Disable.Attributes.Add("data-content", "CmsLabels");
            ...
            HyperLink_Action_Delete.Attributes.Add("data-content", "CmsLabels");
            ...
            //Cms.CmsLabels.Description;
            cmsLabelKey = "Cms.CmsLabels.Description";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
            Literal_Column_Header_Description.Text = headerTitle;
            //Cms.CmsLabels.Note;
            cmsLabelKey = "Cms.CmsLabels.Note";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
			...
			*/
            ...
            // Uc
            sidebarMenu1.currentCmsSubSections = "CmsLabels";
			sidebarMenu1.currentCmsSubSections_SectionUri = sectionUri;
            sidebarMenu1.currentCmsUserSession = currentCmsUserSession;
        ...
        {
            // Request List
            CmsLabelsListOptions rq = new CmsLabelsListOptions();
            ...
            // List Response
            CmsLabelsListResponse responseList = objCmsBoDataLibs.CmsLabelsListForCms(header, rq);
        ...
        protected void Repeater_List_Column_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                //
                CmsLabels currentObj = (CmsLabels)e.Item.DataItem;
                ...
                myHyperLink_Delete.Attributes.Add("data-content", "CmsLabels");
                ...
                myHyperLink_EnableDisable.Attributes.Add("data-content", "CmsLabels");
                ...
                // Description
                String sDescription = currentObj.Description;
                sDescription = objLibString.sStripHTML(sDescription);
                Literal myLiteral_Column_Description = (Literal)e.Item.FindControl("Literal_Column_Description");
                myLiteral_Column_Description.Text = objLibString.TroncaTesto(sDescription, 100, true);
