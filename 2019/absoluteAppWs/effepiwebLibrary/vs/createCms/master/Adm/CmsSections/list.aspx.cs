...
namespace backOffice.cmssections
{
    public partial class list : System.Web.UI.Page
    {
        ...
        protected void InitPage()
        {
            ...
            HyperLink_Action_Enable.Attributes.Add("data-content", "CmsSections");
            ...
            HyperLink_Action_Disable.Attributes.Add("data-content", "CmsSections");
            ...
            HyperLink_Action_Delete.Attributes.Add("data-content", "CmsSections");
            ...
            //Cms.CmsSections.Title;
            cmsLabelKey = "Cms.CmsSections.Title";
            ...
            Literal_Column_Header_Title.Text = headerTitle;
            //Cms.CmsSections.ContentTable;
            cmsLabelKey = "Cms.CmsSections.ContentTable";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
            Literal_Column_Header_ContentTable.Text = headerTitle;
            //Cms.CmsSections.SectionUri;
            cmsLabelKey = "Cms.CmsSections.SectionUri";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
            Literal_Column_Header_SectionUri.Text = headerTitle;
            //Cms.CmsSections.Link;
            cmsLabelKey = "Cms.CmsSections.Link";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
            Literal_Column_Header_Link.Text = headerTitle;
            //Cms.CmsSections.Link_Target;
            cmsLabelKey = "Cms.CmsSections.Link_Target";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
            Literal_Column_Header_Link_Target.Text = headerTitle;
            //Cms.CmsSections.Link_Preview;
            cmsLabelKey = "Cms.CmsSections.Link_Preview";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
            Literal_Column_Header_Link_Preview.Text = headerTitle;
            //Cms.CmsSections.IconClass;
            cmsLabelKey = "Cms.CmsSections.IconClass";
            headerTitle = currentCmsUserSession.GetGlobalLabel(cmsLabelKey);
            if (String.IsNullOrEmpty(headerTitle))
                headerTitle = cmsLabelKey.Substring(cmsLabelKey.LastIndexOf(".") + 1);
            Literal_Column_Header_IconClass.Text = headerTitle;
			...
			*/
            ...
            // Uc
            sidebarMenu1.currentCmsSubSections = "CmsSections";
			sidebarMenu1.currentCmsSubSections_SectionUri = sectionUri;
            sidebarMenu1.currentCmsUserSession = currentCmsUserSession;
        ...
        protected void Repeater_List_Bind(Boolean bPaging)
        {
            ...
            // List Response
            CmsSectionsListResponse responseList = objCmsBoDataLibs.CmsSectionsList(header, rq);
        ...
        protected void Repeater_List_Column_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                //
                CmsSections currentObj = (CmsSections)e.Item.DataItem;
                ...
                myHyperLink_Delete.Attributes.Add("data-content", "CmsSections");
                ...
                myHyperLink_EnableDisable.Attributes.Add("data-content", "CmsSections");
                ...
                if (currentObj.Title != null)
                    sTitle = currentObj.Title.ToString();
                Literal myLiteral_Column_Title = (Literal)e.Item.FindControl("Literal_Column_Title");
                myLiteral_Column_Title.Text = sTitle;
                
                // ContentTable
                String sContentTable = String.Empty;
                if (currentObj.ContentTable != null)
                    sContentTable = currentObj.ContentTable.ToString();
                Literal myLiteral_Column_ContentTable = (Literal)e.Item.FindControl("Literal_Column_ContentTable");
                myLiteral_Column_ContentTable.Text = sContentTable;
                
                // SectionUri
                String sSectionUri = String.Empty;
                if (currentObj.SectionUri != null)
                    sSectionUri = currentObj.SectionUri.ToString();
                Literal myLiteral_Column_SectionUri = (Literal)e.Item.FindControl("Literal_Column_SectionUri");
                myLiteral_Column_SectionUri.Text = sSectionUri;
                
                // Link
                String sLink = String.Empty;
                if (currentObj.Link != null)
                    sLink = currentObj.Link.ToString();
                Literal myLiteral_Column_Link = (Literal)e.Item.FindControl("Literal_Column_Link");
                myLiteral_Column_Link.Text = sLink;
                
                // Link_Target
                String sLink_Target = String.Empty;
                if (currentObj.Link_Target != null)
                    sLink_Target = currentObj.Link_Target.ToString();
                Literal myLiteral_Column_Link_Target = (Literal)e.Item.FindControl("Literal_Column_Link_Target");
                myLiteral_Column_Link_Target.Text = sLink_Target;
                
                // Link_Preview
                String sLink_Preview = String.Empty;
                if (currentObj.Link_Preview != null)
                    sLink_Preview = currentObj.Link_Preview.ToString();
                Literal myLiteral_Column_Link_Preview = (Literal)e.Item.FindControl("Literal_Column_Link_Preview");
                myLiteral_Column_Link_Preview.Text = sLink_Preview;
                
                // IconClass
                String sIconClass = String.Empty;
                if (currentObj.IconClass != null)
                    sIconClass = currentObj.IconClass.ToString();
                Literal myLiteral_Column_IconClass = (Literal)e.Item.FindControl("Literal_Column_IconClass");
                myLiteral_Column_IconClass.Text = sIconClass;
