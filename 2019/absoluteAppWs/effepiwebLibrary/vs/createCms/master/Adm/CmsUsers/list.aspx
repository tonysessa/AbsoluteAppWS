<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" EnableEventValidation="false" Inherits="backOffice.cmsusers.list" %>
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="record-data-header txt-middle">
                                                            <asp:Literal ID="Literal_Column_Header_Name" runat="server">Name</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_Name" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="Name" runat="server"><i id="iLinkButton_Column_Header_Name" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
                                                        <th class="record-data-header txt-middle">
                                                            <asp:Literal ID="Literal_Column_Header_Surname" runat="server">Surname</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_Surname" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="Surname" runat="server"><i id="iLinkButton_Column_Header_Surname" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
                                                        <th class="record-data-header txt-middle">
                                                            <asp:Literal ID="Literal_Column_Header_Email" runat="server">Email</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_Email" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="Email" runat="server"><i id="iLinkButton_Column_Header_Email" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
                                                        <th class="record-data-header txt-middle">
                                                            <asp:Literal ID="Literal_Column_Header_Username" runat="server">Username</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_Username" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="Username" runat="server"><i id="iLinkButton_Column_Header_Username" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
                                                        <!--<th class="record-data-header txt-middle">
                                                            <asp:Literal ID="Literal_Column_Header_Password" runat="server">Password</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_Password" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="Password" runat="server"><i id="iLinkButton_Column_Header_Password" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>-->
                                                        <th class="record-data-header">
                                                            <asp:Literal ID="Literal_Column_Header_DateLastLogin" runat="server">DateLastLogin</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_DateLastLogin" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="DateLastLogin" runat="server"><i id="iLinkButton_Column_Header_DateLastLogin" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
                                                        <th class="record-data-header">
                                                            <asp:Literal ID="Literal_Column_Header_NumLogin" runat="server">NumLogin</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_NumLogin" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="NumLogin" runat="server"><i id="iLinkButton_Column_Header_NumLogin" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
                                                        <th class="record-data-header">
                                                            <asp:Literal ID="Literal_Column_Header_Uid_CmsRoles" runat="server">Uid_CmsRoles</asp:Literal><asp:LinkButton ID="LinkButton_Column_Header_Uid_CmsRoles" OnClick="LinkButton_Column_Header_Click" CausesValidation="false" CommandArgument="Uid_CmsRoles" runat="server"><i id="iLinkButton_Column_Header_Uid_CmsRoles" runat="server" class="fa fa-sort - desc"></i></asp:LinkButton></th>
                                                        <!--<th class="record-data-header txt-long"><asp:Literal ID="Literal_Column_Header_Note" runat="server">Note</asp:Literal></th>-->


                                                    </tr>
                                                </thead>
                                                <tbody class="listsortable" runat="server" id="tbody" contenttable="CmsUsers">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td class="record-data txt-middle">
                                                                    <asp:Literal ID="Literal_Column_Name" runat="server"></asp:Literal></td>
                                                                <td class="record-data txt-middle">
                                                                    <asp:Literal ID="Literal_Column_Surname" runat="server"></asp:Literal></td>
                                                                <td class="record-data txt-middle">
                                                                    <asp:Literal ID="Literal_Column_Email" runat="server"></asp:Literal></td>
                                                                <td class="record-data txt-middle">
                                                                    <asp:Literal ID="Literal_Column_Username" runat="server"></asp:Literal></td>
                                                                <!--<td class="record-data txt-middle">
                                                                    <asp:Literal ID="Literal_Column_Password" runat="server"></asp:Literal></td>-->
                                                                <td class="record-data">
                                                                    <asp:Literal ID="Literal_Column_DateLastLogin" runat="server"></asp:Literal></td>
                                                                <td class="record-data">
                                                                    <asp:Literal ID="Literal_Column_NumLogin" runat="server"></asp:Literal></td>
                                                                <td class="record-data">
                                                                    <asp:Literal ID="Literal_Column_Uid_CmsRoles" runat="server"></asp:Literal></td>
