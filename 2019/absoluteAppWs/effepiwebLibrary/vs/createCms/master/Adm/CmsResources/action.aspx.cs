			...
			if (currentCmsUserSession != null)
            {
				...
				if (!String.IsNullOrEmpty(sDataUid))
				{
					...
					if (sDataAction.ToLower().Equals("delete"))
					{
						...
						CmsResourcesItemResponse responseUserGet = objCmsBoDataLibs.CmsResourcesGetCms(header, sDataUid);
						...
						if (updateObject != null)
						{
						    ...
						    CmsResourcesItemResponse responseUpsert = objCmsBoDataLibs.CmsResourcesUpsert(header, updateObject);
